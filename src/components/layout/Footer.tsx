        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 leading-7 text-slate-600">
              Building websites, mobile applications and custom
            ...
            <div className="mt-6 flex gap-3">
              ...
              <a
                ...
                target="_blank"
                className="rounded-full bg-green-600 border border-slate-300 px-4 py-2 text-sm transition-all duration-300 hover:bg-slate-900 hover:text-white"
              >
                WhatsApp
              </a>
              ...
              <a
                ...
                target="_blank"
                className="rounded-full bg bg-pink-600 border border-slate-300 px-4 py-2 text-sm transition-all duration-300 hover:bg-slate-900 hover:text-white"
              >
                Instagram
              </a>
